...
import Tenis from '../../../assets/images/keyserve.png'
            ...
            <ScrollView>
                <View>
                    ...
                    <View style={styles.viewimagetext}>
                        <Text style={{ fontSize: 30, color: 'white', marginLeft: -330, fontWeight: 'bold' }}>Serve</Text>
                ...
                <View style={styles.carousal}>
                    <Text style={styles.txtTraining}>Table Tennis Serve Videos</Text>
                ...
                <View style={styles.carousal}>
                    <Text style={styles.txtTraining}>Serve Videos</Text>
                    <ScrollView horizontal={true}>
                        <View style={styles.coachThumbnail}>
                            {imgs.map((src, index) => (
                                <Datacard key={index} thumbnail={src} />
