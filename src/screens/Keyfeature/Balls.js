...
import Tenis from '../../../assets/images/ballkey.png'
            ...
            <ScrollView>
                <View>
                    ...
                    <View style={styles.viewimagetext}>
                        <Text style={{ fontSize: 30, color: 'white', marginLeft: -350, fontWeight: 'bold' }}>Balls</Text>
                ...
                <View style={styles.carousal}>
                    <Text style={styles.txtTraining}>Table Tennis Balls Videos</Text>
                ...
                <View style={styles.carousal}>
                    <Text style={styles.txtTraining}>Balls Videos</Text>
                    <ScrollView horizontal={true}>
                        <View style={styles.coachThumbnail}>
                            {imgs.map((src, index) => (
                                <Datacard key={index} thumbnail={src} />
