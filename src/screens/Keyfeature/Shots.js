...
import Tenis from '../../../assets/images/ttshotskey.png'
            ...
            <ScrollView>
                <View>
                    ...
                    <View style={styles.viewimagetext}>
                        <Text style={{ fontSize: 30, color: 'white', marginLeft: -330, fontWeight: 'bold' }}>Shots</Text>
                ...
                <View style={styles.carousal}>
                    <Text style={styles.txtTraining}>Table Tennis Shots Videos</Text>
                ...
                <View style={styles.carousal}>
                    <Text style={styles.txtTraining}>Balls key Videos</Text>
                    <ScrollView horizontal={true}>
                        <View style={styles.coachThumbnail}>
                            {imgs.map((src, index) => (
                                <Datacard key={index} thumbnail={src} />
