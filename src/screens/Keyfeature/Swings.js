...
import Tenis from '../../../assets/images/keyswing.png'
            ...
            <ScrollView>
                <View>
                    ...
                    <View style={styles.viewimagetext}>
                        <Text style={{ fontSize: 30, color: 'white', marginLeft: -330, fontWeight: 'bold' }}>Swing</Text>
                ...
                <View style={styles.carousal}>
                    <Text style={styles.txtTraining}>Table Tennis Swing Videos</Text>
                ...
                <View style={styles.carousal}>
                    <Text style={styles.txtTraining}>Swings  Videos</Text>
                    <ScrollView horizontal={true}>
                        <View style={styles.coachThumbnail}>
                            {imgs.map((src, index) => (
                                <Datacard key={index} thumbnail={src} />
